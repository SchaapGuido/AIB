...
<#
Write-Host '*** WVD AIB CUSTOMIZER PHASE *** INSTALL *** Install Languagepacks ***'
Invoke-WebRequest -uri 'https://pubwvdaib.blob.core.windows.net/install/LanguageExperiencePack.nl-NL.Neutral.appx' -OutFile C:\Temp\LanguageExperiencePack.nl-NL.Neutral.appx
Invoke-WebRequest -uri 'https://pubwvdaib.blob.core.windows.net/install/License.xml' -OutFile C:\Temp\License.xml
Invoke-WebRequest -uri 'https://pubwvdaib.blob.core.windows.net/install/Microsoft-Windows-Client-Language-Pack_x64_nl-nl.cab' -OutFile C:\Temp\Microsoft-Windows-Client-Language-Pack_x64_nl-nl.cab
Invoke-WebRequest -uri 'https://pubwvdaib.blob.core.windows.net/install/Microsoft-Windows-LanguageFeatures-Basic-nl-nl-Package~31bf3856ad364e35~amd64~~.cab' -OutFile C:\Temp\Microsoft-Windows-LanguageFeatures-Basic-nl-nl-Package~31bf3856ad364e35~amd64~~.cab
Invoke-WebRequest -uri 'https://pubwvdaib.blob.core.windows.net/install/Microsoft-Windows-LanguageFeatures-Handwriting-nl-nl-Package~31bf3856ad364e35~amd64~~.cab' -OutFile C:\Temp\Microsoft-Windows-LanguageFeatures-Handwriting-nl-nl-Package~31bf3856ad364e35~amd64~~.cab
Invoke-WebRequest -uri 'https://pubwvdaib.blob.core.windows.net/install/Microsoft-Windows-LanguageFeatures-OCR-nl-nl-Package~31bf3856ad364e35~amd64~~.cab' -OutFile C:\Temp\Microsoft-Windows-LanguageFeatures-OCR-nl-nl-Package~31bf3856ad364e35~amd64~~.cab
Invoke-WebRequest -uri 'https://pubwvdaib.blob.core.windows.net/install/Microsoft-Windows-LanguageFeatures-TextToSpeech-nl-nl-Package~31bf3856ad364e35~amd64~~.cab' -OutFile C:\Temp\Microsoft-Windows-LanguageFeatures-TextToSpeech-nl-nl-Package~31bf3856ad364e35~amd64~~.cab
Start-Sleep -Seconds 10
Invoke-Expression -Command 'DISM.exe /Online /Add-ProvisionedAppxPackage /PackagePath:c:\temp\languageexperiencepack.nl-nl.neutral.appx /LicensePath:c:\temp\License.xml'
Start-Sleep -Seconds 10
...
Start-Sleep -Seconds 10
Invoke-Expression -Command 'DISM.exe /Online /Add-Package /PackagePath:c:\temp\Microsoft-Windows-LanguageFeatures-Basic-nl-nl-Package~31bf3856ad364e35~amd64~~.cab'
Start-Sleep -Seconds 10
Invoke-Expression -Command 'DISM.exe /Online /Add-Package /PackagePath:c:\temp\Microsoft-Windows-LanguageFeatures-Handwriting-nl-nl-Package~31bf3856ad364e35~amd64~~.cab'
Start-Sleep -Seconds 10
Invoke-Expression -Command 'DISM.exe /Online /Add-Package /PackagePath:c:\temp\Microsoft-Windows-LanguageFeatures-OCR-nl-nl-Package~31bf3856ad364e35~amd64~~.cab'
Start-Sleep -Seconds 10
Invoke-Expression -Command 'DISM.exe /Online /Add-Package /PackagePath:c:\temp\Microsoft-Windows-LanguageFeatures-TextToSpeech-nl-nl-Package~31bf3856ad364e35~amd64~~.cab'
Start-Sleep -Seconds 15
#>

Write-Host '*** WVD AIB CUSTOMIZER PHASE *** INSTALL *** Install Office ***'
Invoke-WebRequest -uri 'https://raw.githubusercontent.com/SchaapGuido/AIB/main/setup.exe' -OutFile C:\Temp\Setup.exe
Invoke-WebRequest -uri 'https://raw.githubusercontent.com/SchaapGuido/AIB/main/Config.xml' -OutFile C:\Temp\Config.xml
Start-Sleep -Seconds 10
Invoke-Expression -Command 'C:\Temp\Setup.exe /download C:\Temp\Config.xml'
Start-Sleep -Seconds 10
Invoke-Expression -Command 'C:\Temp\Setup.exe /configure C:\Temp\Config.xml'
Start-Sleep -Seconds 15
...
Invoke-WebRequest -Uri 'https://github.com/notepad-plus-plus/notepad-plus-plus/releases/download/v7.9.2/npp.7.9.2.Installer.x64.exe' `
    -OutFile 'c:\temp\notepadplusplus.exe'
